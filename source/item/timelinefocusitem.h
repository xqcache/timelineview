...
namespace tl {
class TIMELINE_LIB_EXPORT TimelineFocusItem : public TimelineItem {
public:
    enum PropertyRole {
    ...
    TimelineFocusItem(ItemID item_id, TimelineModel* model);
...
private:
    friend void from_json(const nlohmann::json& j, TimelineFocusItem& item);
